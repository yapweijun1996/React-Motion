...
export const ELEMENT_CATALOG = [
  ...
  },
  {
    ...
    svg_quality_rules: "CRITICAL — generate PREMIUM quality SVG, not bare shapes. Follow these rules: (1) USE <defs> for gradients (<linearGradient>, <radialGradient>), reusable markers, and glow filters. (2) Every major shape must have gradient fill, rounded corners (rx), and a subtle stroke border — never flat single-color rectangles. (3) ADD DETAIL: labels with font-size 16-22, data badges/pills (small rounded rects with text inside), metric callouts, dotted connector lines (<line stroke-dasharray='4,4'>). (4) USE VISUAL HIERARCHY: primary elements larger and brighter, secondary elements smaller and muted. (5) For nodes/entities: use circles or rounded rects with icon-like symbols inside (a letter, a simple glyph). (6) For connections/flows: use paths with arrowhead markers, varying stroke-width for importance. (7) ADD CONTEXT: axis labels, legend dots, scale indicators, subtle grid lines where appropriate. (8) COLOR DEPTH: use 3-4 opacity levels of palette colors (full, 70%, 40%, 15%) for layered depth. (9) MINIMUM COMPLEXITY: at least 15-20 SVG elements per diagram — a diagram with only 3-5 shapes looks empty on a 1920x1080 canvas. The quality gate REJECTS SVGs with fewer than 10 visual elements. (10) viewBox should be 800x500 or similar wide format. Text uses fill attribute, not CSS color.",
    markup_example: `<svg viewBox="0 0 800 500" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="gA" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#0f766e" stop-opacity="0.9"/><stop offset="100%" stop-color="#0f766e" stop-opacity="0.5"/></linearGradient><linearGradient id="gB" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#3b82f6" stop-opacity="0.9"/><stop offset="100%" stop-color="#3b82f6" stop-opacity="0.5"/></linearGradient><marker id="arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M 0 0 L 10 5 L 0 10 z" fill="#94a3b8"/></marker></defs><rect x="40" y="180" width="200" height="120" rx="16" fill="url(#gA)" stroke="#0f766e" stroke-width="1.5"/><text x="140" y="215" text-anchor="middle" fill="#e2e8f0" font-size="18" font-weight="bold">数据采集</text><rect x="70" y="230" width="70" height="26" rx="8" fill="rgba(15,118,110,0.3)"/><text x="105" y="248" text-anchor="middle" fill="#99f6e4" font-size="12">API 接入</text><rect x="150" y="230" width="70" height="26" rx="8" fill="rgba(15,118,110,0.3)"/><text x="185" y="248" text-anchor="middle" fill="#99f6e4" font-size="12">文件上传</text><rect x="70" y="264" width="150" height="26" rx="8" fill="rgba(15,118,110,0.2)"/><text x="145" y="282" text-anchor="middle" fill="#5eead4" font-size="11">日处理量: 50万条</text><line x1="240" y1="240" x2="300" y2="240" stroke="#94a3b8" stroke-width="1.5" marker-end="url(#arrow)"/><rect x="300" y="180" width="200" height="120" rx="16" fill="url(#gB)" stroke="#3b82f6" stroke-width="1.5"/><text x="400" y="215" text-anchor="middle" fill="#e2e8f0" font-size="18" font-weight="bold">智能分析</text><rect x="330" y="230" width="60" height="26" rx="8" fill="rgba(59,130,246,0.3)"/><text x="360" y="248" text-anchor="middle" fill="#93c5fd" font-size="12">NLP</text><rect x="400" y="230" width="80" height="26" rx="8" fill="rgba(59,130,246,0.3)"/><text x="440" y="248" text-anchor="middle" fill="#93c5fd" font-size="12">预测模型</text><rect x="330" y="264" width="150" height="26" rx="8" fill="rgba(59,130,246,0.2)"/><text x="405" y="282" text-anchor="middle" fill="#93c5fd" font-size="11">准确率: 96.3%</text><line x1="500" y1="240" x2="560" y2="240" stroke="#94a3b8" stroke-width="1.5" marker-end="url(#arrow)"/><rect x="560" y="180" width="200" height="120" rx="16" fill="url(#gA)" stroke="#0f766e" stroke-width="1.5"/><text x="660" y="215" text-anchor="middle" fill="#e2e8f0" font-size="18" font-weight="bold">报告输出</text><rect x="590" y="230" width="70" height="26" rx="8" fill="rgba(15,118,110,0.3)"/><text x="625" y="248" text-anchor="middle" fill="#99f6e4" font-size="12">可视化</text><rect x="670" y="230" width="70" height="26" rx="8" fill="rgba(15,118,110,0.3)"/><text x="705" y="248" text-anchor="middle" fill="#99f6e4" font-size="12">PDF导出</text><rect x="590" y="264" width="150" height="26" rx="8" fill="rgba(15,118,110,0.2)"/><text x="665" y="282" text-anchor="middle" fill="#5eead4" font-size="11">月生成 1200+</text><text x="400" y="440" text-anchor="middle" fill="#64748b" font-size="14">数据处理管线 — 3阶段全自动化流程</text><circle cx="140" cy="140" r="4" fill="#0f766e" opacity="0.6"/><circle cx="400" cy="140" r="4" fill="#3b82f6" opacity="0.6"/><circle cx="660" cy="140" r="4" fill="#0f766e" opacity="0.6"/><line x1="140" y1="144" x2="140" y2="180" stroke="#0f766e" stroke-dasharray="4,4" stroke-width="1" opacity="0.4"/><line x1="400" y1="144" x2="400" y2="180" stroke="#3b82f6" stroke-dasharray="4,4" stroke-width="1" opacity="0.4"/><line x1="660" y1="144" x2="660" y2="180" stroke="#0f766e" stroke-dasharray="4,4" stroke-width="1" opacity="0.4"/></svg>`,
  },
  {
    type: "svg-3d",
