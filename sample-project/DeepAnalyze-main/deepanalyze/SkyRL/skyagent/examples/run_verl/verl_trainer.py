...
class SkyAgentPPOTrainer(RayPPOTrainer):
    ...
    def init_workers(self):
        ...
        if self.config.actor_rollout_ref.rollout.mode == "async":
            from skyagent.integrations.verl.verl_async_manager import (
                SkyAgentLoopManager,
            )
                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("gen", timing_raw, color="red"):
                        ...
                        if "rollout_metrics" in gen_batch_output.meta_info.keys():
                            rollout_metrics = reduce_metrics(
                                gen_batch_output.meta_info["rollout_metrics"]
                            )
                    ...
                    batch = batch.repeat(
                        repeat_times=self.config.skyagent.num_trajectories,
                        interleave=True,
                    )
                    ...
                    print(
                        ...
                        len(batch.batch),
                        " Num trajectories: ",
                        self.config.skyagent.num_trajectories,
                    )
