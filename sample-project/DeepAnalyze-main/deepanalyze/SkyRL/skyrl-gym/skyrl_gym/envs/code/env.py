...
import re
from skyrl_gym.envs.code.utils import compute_score_single
import os
...
class CodeEnv(BaseTextEnv):
    ...
    def __init__(self, env_config: DictConfig, extras: Dict[str, Any] = {}):
        ...
        self.file_path = env_config.file_path
        ...
        self.db_file = os.path.join(self.file_path, self.db_id, self.db_id + ".sqlite")
        ...
        self.tool_group = SQLCodeExecutorToolGroup(db_file_path=self.file_path)
