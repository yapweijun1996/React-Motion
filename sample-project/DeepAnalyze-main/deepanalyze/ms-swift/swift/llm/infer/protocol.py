    ...
    def __post_init__(self):
        ...
        if self.tools:
            if self.tool_choice == "none":
                ...
                tool = next(
                    tool for tool in self.tools if tool["function"]["name"] == name
                )
                if tool is None:
...
class ChatCompletionRequest(
    RequestConfig, MultiModalRequestMixin, ChatCompletionRequestMixin
):
    ...
    @classmethod
    def from_cmpl_request(
        cls, cmpl_request: CompletionRequest
...
class ChatCompletionResponseChoice:
    ...
    def to_cmpl_choice(self) -> "CompletionResponseChoice":
        ...
        return CompletionResponseChoice(
            self.index, self.message.content, self.finish_reason, self.logprobs
        )
...
class ChatCompletionResponse:
    ...
    def to_cmpl_response(self) -> "CompletionResponse":
        ...
        return CompletionResponse(
            self.model, choices, self.usage, id_, created=self.created
        )
...
class ChatCompletionResponseStreamChoice:
    ...
    def to_cmpl_choice(self) -> "CompletionResponseStreamChoice":
        ...
        return CompletionResponseStreamChoice(
            self.index, self.delta.content, self.finish_reason, self.logprobs
        )
