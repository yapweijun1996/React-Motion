...
class VllmArguments:
    ...
    def __post_init__(self):
        self.limit_mm_per_prompt = ModelArguments.parse_to_dict(
...
class InferArguments(
    MergeArguments, LmdeployArguments, SglangArguments, VllmArguments, BaseArguments
):
    """
    ...
    def _init_stream(self):
        self.eval_human = not (
            self.dataset and self.split_dataset_ratio > 0 or self.val_dataset
        )
